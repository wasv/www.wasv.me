...
* A transport layer for the [ZCM Communication Framework](https://github.com/ZeroCM/zcm) used to write messages over a standard POSIX character device.
...
## [Influxdb](https://influxdata.com/) / [Grafana](http://grafana.org/) Data Analytics System
